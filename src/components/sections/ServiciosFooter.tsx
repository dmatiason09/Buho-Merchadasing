  ...
  return (
    ...
    >
      <a
        ...
        // Íconos sin URL real (placeholder "#", ej. Facebook aún sin página) no
        // navegan al hacer clic; cuando tengan su URL (http...) abrirán normal.
        onClick={(e) => {
...
export function ServiciosFooter() {
  ...
  return (
    ...
    >
      ...
      >
        <MagneticSocial href="#" label="Facebook">
        ...
        <MagneticSocial href="https://www.tiktok.com/@buho_studio3" label="TikTok">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
        ...
        <MagneticSocial href="https://x.com/BuhoStudioPe" label="X (Twitter)">
